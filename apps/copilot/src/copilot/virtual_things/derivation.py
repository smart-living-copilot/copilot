...
capability scoping (see :mod:`copilot.virtual_things.capabilities`); here we also record
...
context URL: the RDF materializer (see :mod:`copilot.rdf.contexts`) only resolves the
