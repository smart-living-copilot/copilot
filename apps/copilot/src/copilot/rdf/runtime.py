...
class RdfStreamConfig:
    ...
    def from_settings(cls, settings: Settings) -> RdfStreamConfig:
        ...
        return cls(
            stream=rdf.thing_events_stream,
            group=rdf.events_group,
            consumer=rdf.events_consumer,
            batch_size=rdf.events_batch_size,
            poll_block_ms=rdf.events_poll_block_ms,
            claim_idle_ms=rdf.events_claim_idle_ms,
            retry_seconds=rdf.events_retry_seconds,
        )
