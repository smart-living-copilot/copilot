...
from copilot.virtual_things.enrichment import VirtualThingEnrichmentScheduler
...
def test_record_thing_mint_schedules_enrichment(monkeypatch):
    from copilot.jobs.resources import manager
    from copilot.virtual_things import enrichment
...
def test_silent_run_config_suppresses_chat_streaming():
    ...
    from copilot.virtual_things.enrichment import _SILENT_RUN_CONFIG
