...
from wotbot.rdf.schema import is_domain_iri, summarize_schema
...
def test_describe_rdf_schema_tool_filters_and_calls_client_twice():
    from wotbot.agent.tools.wot_registry import REGISTRY_TOOLS, describe_rdf_schema
    ...
    with patch("wotbot.agent.tools.wot_registry._rdf_client", return_value=client):
