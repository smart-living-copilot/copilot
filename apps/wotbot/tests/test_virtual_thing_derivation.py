...
from wotbot.virtual_things.derivation import DERIVED_FROM, PROV_NAMESPACE, PROV_PREFIX
from wotbot.virtual_things.schemas import DefineVirtualThingRequest
