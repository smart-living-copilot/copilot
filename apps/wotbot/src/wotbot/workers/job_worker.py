...
from wotbot.jobs.executor import close_job_executor, get_job_executor
from wotbot.jobs.taskiq_app import broker, run_job_task, settings
...
async def _worker_startup(_state: object) -> None:
    ...
    from wotbot.jobs.events import JobEventConsumer  # lazy: avoids import cycle
