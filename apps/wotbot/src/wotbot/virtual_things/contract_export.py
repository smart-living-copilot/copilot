"""Export the wotbot <-> virtual-servient wire contract as JSON Schema.
...
Usage::
    ...
    python -m wotbot.virtual_things.contract_export            # print schema
    python -m wotbot.virtual_things.contract_export <out.json>  # write schema
...
from wotbot.virtual_things.schemas import VirtualThingServientView
