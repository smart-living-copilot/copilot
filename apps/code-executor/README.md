...
- [`code_executor/session_pool.py`](./code_executor/session_pool.py): async session pool orchestration
- [`code_executor/worker.py`](./code_executor/worker.py): isolated process worker loop and rollback behavior
- [`code_executor/execution_environment.py`](./code_executor/execution_environment.py): `exec(...)`, globals, stdout, and artifact capture
- [`code_executor/wot_client.py`](./code_executor/wot_client.py): sandbox-facing WoT client
- [`code_executor/processes.py`](./code_executor/processes.py): process lifecycle helpers
...
- mounts `apps/code-executor/code_executor -> /app/code_executor`
